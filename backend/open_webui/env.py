...
# Python 3.9 compatibility - getLevelNamesMapping was added in Python 3.11
try:
...
WEBUI_SECRET_KEY = os.environ.get(
    "WEBUI_SECRET_KEY",
    os.environ.get(
        "WEBUI_JWT_SECRET_KEY", ""  # Remove hardcoded default
...
OTEL_EXPORTER_OTLP_ENDPOINT = os.environ.get(
    "OTEL_EXPORTER_OTLP_ENDPOINT", ""  # Remove hardcoded localhost default
)
